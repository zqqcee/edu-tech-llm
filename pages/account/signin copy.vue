          ...
          <v-card class="mt-15" elevation="0">
            ...
            <v-card-text>
              <v-form ref="signInForm">
                <v-text-field v-model="formData.username" :rules="formRules.username" :label="$t('username')"
                  variant="underlined" clearable></v-text-field>
                <v-text-field v-model="formData.password" :rules="formRules.password" :label="$t('password')"
                  variant="underlined" @keyup.enter="submit" clearable :type="passwordInputType"
              ...
              <div class="mt-5 d-flex justify-space-between">
                ...
                <v-btn color="primary" :loading="submitting" @click="submit" size="large">{{ $t('signIn') }}</v-btn>
              </div>
